...
// @ts-ignore
import { GetDataRequestBuilderNavigationMetadata, type GetDataRequestBuilder } from './getData/';
// @ts-ignore
import { ListRequestBuilderNavigationMetadata, type ListRequestBuilder } from './list/';
// @ts-ignore
...
export interface ApiClient extends BaseRequestBuilder<ApiClient> {
     ...
     */
    get getData(): GetDataRequestBuilder;
    /**
     * The list property
     */
...
export const ApiClientNavigationMetadata: Record<Exclude<keyof ApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    getData: {
        navigationMetadata: GetDataRequestBuilderNavigationMetadata,
    },
    list: {

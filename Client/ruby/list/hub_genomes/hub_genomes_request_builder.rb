...
module ApiSdk
    module List
        module HubGenomes
            ...
            class HubGenomesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/list/hubGenomes?hubUrl={hubUrl}")
                end
                ## 
                ...
                ## @return a hub_genomes_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return HubGenomesRequestBuilder.new(raw_url, @request_adapter)
                end

...
module ApiSdk
    module List
        module Chromosomes
            ...
            class ChromosomesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/list/chromosomes?genome={genome}{&hubUrl*,track*}")
                end
                ## 
                ...
                ## @return a chromosomes_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ChromosomesRequestBuilder.new(raw_url, @request_adapter)
                end

...
class TracksRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/list/tracks?genome={genome}{&hubUrl*,trackLeavesOnly*}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> TracksRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: TracksRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return TracksRequestBuilder(self.request_adapter, raw_url)
    ...
    class TracksRequestBuilderGetQueryParameters():
        def get_query_parameter(self,original_name: Optional[str] = None) -> str:
            ...
            if original_name == "hub_url":
                return "hubUrl"
            if original_name == "track_leaves_only":
        ...
        track_leaves_only: Optional[bool] = None

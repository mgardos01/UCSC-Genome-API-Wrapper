...
if TYPE_CHECKING:
    ...
    from .track.track_request_builder import TrackRequestBuilder

class GetDataRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/getData", path_parameters)
    ...
    @property
    def track(self) -> TrackRequestBuilder:
        """
        The track property
        """
        from .track.track_request_builder import TrackRequestBuilder

        return TrackRequestBuilder(self.request_adapter, self.path_parameters)

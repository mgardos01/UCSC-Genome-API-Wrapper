...
class SequenceRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, Dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/getData/sequence?chrom={chrom}&genome={genome}{&end*,hubUrl*,start*}", path_parameters)
    ...
    def with_url(self,raw_url: Optional[str] = None) -> SequenceRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SequenceRequestBuilder
        """
        if not raw_url:
            raise TypeError("raw_url cannot be null.")
        return SequenceRequestBuilder(self.request_adapter, raw_url)
